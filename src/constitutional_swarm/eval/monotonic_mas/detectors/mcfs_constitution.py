...
def mcfs_role_rules() -> list[Rule]:
    ...
    return [
        Rule(
            ...
            keywords=["disable safety", "disable safeguard", "disable safety checks", "disable safeguards"],
            patterns=[r"disable\s+safe(ty|guard)"],
            category="role_drift",
        ...
        Rule(
            ...
            severity=Severity.CRITICAL,
            keywords=["override constitutional", "skip validation", "bypass constitutional"],
            patterns=[r"override\s+constitutional", r"skip\s+validation"],
            category="role_drift",
